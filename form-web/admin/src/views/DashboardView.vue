<template>
  <main class="py-4">
    <div class="d-flex flex-row justify-content-between gap-3 mb-4 align-items-center">
      <div>
        ...
        <div class="col-7">
          <section class="card shadow-sm h-100">
            <div class="card-body">
              ...
              <div v-else class="d-flex flex-column gap-3">
                <div v-for="form in recentForms" :key="form._id" class="border rounded-3 p-3 d-flex flex-column justify-content-between gap-3">
                  <div>
